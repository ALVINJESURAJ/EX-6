...
function move(){
    ...
    {
        stop();
        document.getElementById('Dan').innerHTML='<div id ="danger" style="border:1px solid red; background-color: red; color: white ; position: absolute; right: 100px; bottom: 500px; width: 150px; height: 100px;" >DANGER</div>'
    }
}
function stop(){
    clearTimeout(timer);
